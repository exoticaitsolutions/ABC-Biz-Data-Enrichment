...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        file_path = r"C:\Users\home\Videos\Komal Work\ABC Biz Data Enrichment\ABC_BizEnrichment\core_app\License Numbers Sample - Input for Scraper - Input for Start #1.csv"
