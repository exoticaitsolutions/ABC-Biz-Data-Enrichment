...
class FilingsInformation(models.Model):
    ...
    principal_city = models.CharField(max_length=200, blank=True, null=True)
    ...
    principal_city_in_ca= models.CharField(max_length=200, blank=True, null=True)
    principal_state_in_ca= models.CharField(max_length=20, blank=True, null=True)
    principal_country_in_ca= models.CharField(max_length=20, blank=True, null=True)
